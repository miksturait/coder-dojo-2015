...
Shoes.app(title: "The Game of Life", width: 800, height: 620, resizable: false) do
  ...
  flow(displace_left: 650) do
    @run_button  = button('Run',  displace_top: -100, width: 100){ play }
    @stop_button = button('Stop', displace_top: -150, displace_left: -100, width: 100){ stop }
  end

  stack(displace_left: 650, displace_top: -500) do
